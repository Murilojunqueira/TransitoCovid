...
**Comentário:** quanto mais próximo de 1 (o valor mínimo teórico, o tempo de atravessar a cidade de madrugada), *maior* é a adesão á quarentena. Quanto maior o valor do indicador, *menor* é a adesão à quarentena. Podemos observar que as maiores cidades brasileiras começaram lentamente a quarentena a partir do dia 06 de abril. Depois de um pequeno repique depois do dia 17/04, houve uma forte guinada em direção ao uma quarentena mais dura. O aumento pontual do dia 30 de abril ainda não configura ainda uma tendência. Aparentemente, os as vésperas de feriado (como dia 17 e dia 30) levam a um repique do indicador.
